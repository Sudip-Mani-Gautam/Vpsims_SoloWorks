    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="page-subtitle">View, manage and send customer purchase invoices</p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <Button className="bg-primary text-white hover:bg-primary/90 h-9" asChild>
            <Link to="/staff/sales"><Plus className="w-4 h-4 mr-2" /> New Invoice</Link>
          </Button>
        </div>
      </div>
      ...
      <Card className="card-standard border-blue-200 bg-blue-50 dark:bg-blue-950 dark:border-blue-800">
        <CardContent className="py-3 px-5 flex items-center gap-3">
          ...
          <p className="text-sm text-blue-800 dark:text-blue-200">
            To create a new invoice, go through the{" "}
            <Link to="/staff/sales" className="font-semibold underline hover:no-underline">Sales Portal</Link>.
            Invoices will appear here automatically after a transaction is completed.
          </p>
        </CardContent>
      </Card>
